...
A special case for chattel mortgage finance is forage finance (shown in Figure 3). To prevent the stockyard from declaring the value of lending capital usage from exceeding actual credit, we encourage the financial institution to cooperate with forage shops (or other related shops) so that financial institutions can directly finance stockyard forage instead of capital. Through this approach, financial institutions only need to pay the forage finance fee to forage shops after the stockyard declares what they need at the production level.
