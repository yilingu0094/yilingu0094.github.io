...
**Background:** The nonconvex-nonconcave minmax problem is an important issue arising in operations management and machine learning theory. For example, many operation objectives are formulated in a nonconvex-nonconcave setting $\min\limits_{x}\max\limits_{y}f(x,y)$
